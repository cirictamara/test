...
let html = `<footer class = "px-3">
                <p class = "mb-1">Copyright &copy; Elrond Cyber 2022 &verbar; All Rights Reserved / <a href = "assets/sitemap.xml" target = "_blank">Sitemap</a> </p>
...
$(".fnc-slide__action-btn").on("click", function() {
    ...
    let modal = $(`.modal[data-text = "${value}"]`);
